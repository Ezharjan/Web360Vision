...
VRUtils.prototype.setPic=function(img,name,style,w,h){
    var w=w || '100%';
    var h=h|| '100%';
    ...
    div.id=name;
    div.style=style;
    div.innerHTML='<img src="'+img+'" height="'+h+'" width="'+w+'">';
    this.vr.container.appendChild(div);
}

VRUtils.prototype.markIcon=function(img,position,name,title,w,h,d){
    var w=w || 0.08;
    var h=h||0.08;
    var d=d||0;
    ...
    var geometry = d?new THREE.CubeGeometry(w, h, d):new THREE.PlaneGeometry(w, h);
